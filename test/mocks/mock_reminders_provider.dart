...
final mockReminder1 = Reminder(
    creationDate: mockReminder1DateTime, id: mockReminder1Id, isDone: mockReminder1IsDone, text: mockReminder1Text);
...
final mockReminder2 = Reminder(
    creationDate: mockReminder2DateTime, id: mockReminder2Id, isDone: mockReminder2IsDone, text: mockReminder2Text);
...
class MockRemindersProvider implements RemindersProvider {
  ...
  @override
  Future<void> deleteAllDocuments({required String userId}) => Future.delayed(oneSecond);
